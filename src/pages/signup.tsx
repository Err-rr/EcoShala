...
export default function Signup() {
  ...
  const handleEmailSignup = () => console.log('Email signup:', { email, password, confirmPassword });
  const handleGoogleSignup = () => console.log('Google signup attempted');
          ...
          <div className="w-full max-w-md">
            ...
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-gray-800 text-base sm:text-lg"
                 style={{ fontFamily: 'sans-serif', fontStyle: 'italic' }}>
                Sign up for your EcoShala account
              </p>
            </div>
