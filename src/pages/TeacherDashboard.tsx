...
import { ArrowLeft, BookOpen, GraduationCap, LogOut, Mail, School, User } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-green-50 px-4">
        <div className="max-w-md text-center bg-white rounded-2xl shadow-lg p-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-3">Teacher profile unavailable</h1>
          <p className="text-gray-600 mb-6">{error ?? "We could not load this teacher account."}</p>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl bg-green-50 p-4">
                ...
                <p className="mt-2 text-xl font-bold text-green-700">{profile.institution}</p>
              </div>
              <div className="rounded-2xl bg-emerald-50 p-4">
                <p className="text-sm text-gray-600">Total Eco Points</p>
                <p className="mt-2 text-xl font-bold text-emerald-700">{profile.ecoPoints}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-lg">
            <div className="mb-4 flex items-center gap-2 text-gray-900">
              ...
              <h2 className="text-xl font-semibold">Teaching Load</h2>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3 rounded-2xl bg-gray-50 px-4 py-3">
                <School className="mt-0.5 h-4 w-4 text-green-600" />
                <div>
                  <p className="text-sm text-gray-500">Teaching Classes</p>
                  <p className="font-medium text-gray-900">{profile.teachingClasses}</p>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-2xl bg-gray-50 px-4 py-3">
